...
os.chdir(r"C:\Users\firas\OneDrive\Desktop\bat-and-ball-game")

cap = cv.VideoCapture(0)

fourcc = cv.VideoWriter_fourcc(*'XVID') # استخدم أي نوع fourcc لتحسين جودة الفيديو المحفوظ
out = cv.VideoWriter('output.avi', fourcc, 30.0, (640, 480)) # إعدادات الفيديو
...
while True:
    ...
    # عكس الصورة لجعل الحركة تتماشى مع اليد
    img = cv.flip(img, 1)
